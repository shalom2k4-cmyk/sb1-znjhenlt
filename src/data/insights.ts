...
export const insights: Insight[] = [
  {
    ...
    videoUrl: 'https://www.youtube.com/embed/0j2jAstJV0Y',
    audioUrl: 'https://example.com/audio/condom-guide-rw.mp3',
  },
  {
    id: '2',
    title: 'PrEP: Imiti yo Kwirinda SIDA',
    summary: 'PrEP (Pre-Exposure Prophylaxis) ni imiti ishobora gukingira SIDA niba ifatwemo buri munsi. Baza umuganga wawe.',
    content: 'PrEP ni imiti ishobora gukingira SIDA niba ifatwemo buri munsi. Ni buntu mu bitaro byinshi i Rwanda kandi ishobora gufasha abari mu bihe by\'ingirabuzimafatizo.',
    category: 'hiv',
    readTime: 4,
    image: 'https://images.pexels.com/photos/11361813/pexels-photo-11361813.jpeg',
    videoUrl: 'https://www.youtube.com/embed/GC70gqGPLkI',
    audioUrl: 'https://example.com/audio/prep-guide-rw.mp3',
  },
  {
    id: '3',
    title: 'Gusuzuma agakoko gatera SIDA',
    summary: 'Isuzuma ry\'SIDA ni inyungu kandi ni buntu mu bitaro byinshi i Rwanda. Isuzumwe buri mwaka.',
    ...
    videoUrl: 'https://www.youtube.com/embed/CZVrJ7Ik8bQ',
  ...
  },
  {
    ...
    content: 'Mu gihe cy\'umwezi, isuku y\'umubiri ni ngombwa cyane. Hindura tamponi cyangwa igitambaro inshuro zirenze 4 ku munsi. Oga buri munsi kugirango wirinde ibyorezo. Niba ukoresha tamponi, irinde kuzisiga amaherezo y\'uburebure.',
    category: 'hygiene',
    readTime: 4,
    image: 'https://kasha-assets-production.s3.amazonaws.com/rw/uploads/2017/11/DSC_7671-3.jpg',
    videoUrl: 'https://www.youtube.com/embed/Z5TP9PE8sm4',
    audioUrl: 'https://example.com/audio/period-hygiene-rw.mp3',
  },
  {
    id: '5',
    title: 'Uburyo bwo Kugabanya Ububabare bw\'Imihango',
    summary: 'Ububabare bw\'umwezi ni ibisanzwe. Hari uburyo bwinshi bwiza bwo kubugabanya nta miti.',
    content: 'Ububabare bw\'umwezi (dysmenorrhea) ni ibisanzwe kuri abagore benshi. Uburyo bwiza bwo kubugabanya: shyira akamero gashyushye ku nda, kora imyitozo yoroheje, nywa amazi menshi, fata iminsi yo kuruhuka.',
    category: 'hygiene',
    readTime: 5,
    image: 'https://www.newtimes.co.rw/thenewtimes/uploads/images/2026/01/19/96149.jpg',
    videoUrl: 'https://www.youtube.com/embed/xjLa9k_I1RI',
