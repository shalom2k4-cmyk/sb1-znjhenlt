...
const menstruationInsights: DayInsight[] = [
  {
    ...
    message:
      "Imihango yatangiye. Umubiri wawe ukora akazi kenshi cyane uyu munsi kuko uri gusohora bimwe mu bigize umura cg nyababyeyi ahateganyirizwaga kwakira igi ryahuye n'intangangabo ariko ntibyakunze. Ibi bituma imisemburo ya Progesterone na Estrogen igabanuka cyane kandi niyo yarigutuma ibyo bice bya nyababyeyi bikomera ntibyangirike kugira ngo umwana azakurire aho munda, bityo rero kwitwararika no kuruhuka ni ngombwa cyane kugira ngo umubiri udasubira inyuma bityo ubashe gukomeza imirimo yawe neza.",
    tips: [
      'Nywa amazi menshi kugirango ugabanye ububabare',
      'Shyira agatambaro gashyushye ku nda yo hasi niba ufite ububabare',
      'Ruhuka neza kandi wirinde imirimo ivunanye cyane uyu munsi',
    ],
    emoji: '🌸',
  },
  {
    ...
    message:
      "Isuku ndetse y'umubiri wawe ni inshingano za buri munsi ariko muri iki gihe by'umwihariko kuko imyanya myibarukiro iba yuguruye kandi ishobora kwandura vuba. Ugomba kwitwararika kuko amaraso ari mu bintu byatuma mikorobe zororoka vuba cyane bityo bikaba byagutera uburwayi. Hindura pads inshuro 3-4 ku munsi bitewe n'uko uva kugira ngo ugumane itoto kandi ntuze kugira ibibazo mu gihe kiri imbere.",
    tips: [
      'Hindura pads inshuro 3-4, tamponi cyangwa igitambaro inshuro zirenze 4 ku munsi',
      "Oga buri munsi kugirango wirinde ibyorezo bishobora guterwa n'imyanda bibaye byiza woge inshuro ebyiri ku munsi muri ibi bihe",
      'Ambara imyenda iguha amahoro kandi itagufashe cyane ariko itanakurekuye cyane kugira ngo pad igume hamwe ikore akazi kayo ariko bitabujije imyanya yawe guhumeka',
    ],
    emoji: '💧',
  },
  {
    ...
    tips: [
      ...
      'Rya neza kandi wirinde kurya byinshi cyane ngo ufutare ariko urye ibihagije',
    ],
    emoji: '🌿',
  },
  {
    ...
    message:
      "Amaraso ari gusohoka ni macye ugereranyije n'iminsi yambere. Umubiri wawe utangira kugira imbaraga nshya gusa bidakabije kuko uba ugitakaza ibituma ugira ingufu. Ni igihe cyiza cyo gutangira gutekereza ku minsi iri imbere no kureba uko wakwitwararika ngo utangire icyumweru gishya ufite akanyamuneza. niba utazanye imihango uyu munsi bishobora kuba byaturutse kuri stress bibaho ko imihango ishobora gushira kuri uyu munsi",
    tips: [
  ...
  },
  {
    ...
    tips: [
      ...
      'Rya ibiryo bigushimisha kandi byubaka umubiri kuko ugiye gutangira kubaka umubiri wariwatakaje',
    ],
    emoji: '🌺',
  },
];
...
const ovulationInsights: DayInsight[] = [
  {
    ...
    message:
      "Uri mu minsi y'uburumbuke . Igi ryamaze gusohoka mu ruganda rwaryo (ovary) rurimo gutegereza guhura n'intangangabo. Niba ushaka gusama iki ni cyo gihe cyo kugerageza ariko niba udashaka gusama uyu munsi urakomeye cyane kuko amahirwe yo gusama ari hafi 100%. Ni ngombwa kumenya ibi kugira ngo ufate imyanzuro ikwiye ku buzima bwawe bw'imyororokere.",
    tips: [
      ...
      'Niba ushaka kwirinda gusama, koresha condom buri gihe nta gushidikanya. niba utazi uburyo bakoresha agakingirizo kanda hasi ku bumenyi maze wige',
    ],
    emoji: '🌟',
  },
  {
    ...
    message:
      "Igitsina gitangira kugira amazi cg amatembabuzi cg ububobere bufashe cg bureduka nk'igi ribisi. ibi bikwereka ko igi ryasohotse cyangwa riri hafi gusohoka vuba cyane. Niba ushaka gusama iki ni cyo gihe cyo kugerageza cyangwa niba udashaka gusama itwararike uyu munsi kuko ubu amatembabuzi arimo koroshya inzira y'intangangabo ngo igere ku igi ryawe vuba cyane.",
    tips: [
      "Kora test y'ovulation niba ushaka kumenya neza aho ugeze",
      'kora mu gitsinda n`intoki zisukuye urebe ko ugutoha kw\'igitsina gufashe gusa buno buryo niba utari inzobere ntubugendereho cyane kuko iki gihe n\'ubundi amahirwe yo gusama ari hejuru, gusa wabigenderaho nk\'ikimenyetso  ',
...
const lutealInsights: DayInsight[] = [
  {
    ...
    message:
      "Uyu munsi Progesterone iriyongera cyane mu gihe cya luteal ugezemo. Ibi bishobora gutuma wiyumva ufite umunaniro, guhindagurika kw'imitekerereze n\'ibyishimo, cyangwa ukumva ufite agahinda bityo ntumenye impamvu. Humura kuko ni imisemburo iri kubikora, ntugatekereze ko ufite ikibazo cyo mu mutwe. Urakomeye kandi ibi biri gufasha umubiri wawe kwitegura indi nzira igiye guza vuba.",
    tips: [
      "Niba utangiye kwishyira mu nkeke - bwira inshuti yawe uganire n'abantu bagusetsa batume wumva uruhutse ntiwigunge uyu munsi",
  ...
  {
    title: 'PMS : ibyiyumviro bidasanzwe',
    message:
...
const longCycleGapInsights: DayInsight[] = [
  {
    ...
    message:
      "Kubera ko ukwezi kwawe kurenza iminsi isanzwe 28 (ukwezi kwawe ni kurekure), umubiri wawe uba uri mu cyitwa 'Extended Follicular Phase'. Ibi bivuze ko imisemburo ya ya Estrogen izamuka buhoro buhoro ugereranyije n'abandi bafite iminsi 28. Ibi ntibivuze ko urwaye cyangwa ufite ikibazo, ahubwo ni umuvuduko w'umubiri wawe uba ari uwo uyu munsi. Komeza ube maso kandi witwararike kuko uburumbuke bwawe buzaza nyuma y'igihe abandi bibwira ko bwapfuye.",
    tips: [
...
export const didYouKnowFacts = [
  ...
  {
    fact: "PrEP ni umuti wizewe ukoreshwa n’abantu batanduye virusi itera SIDA Ariko bari mu byago byo kwandura urugero bitewe n'akazi bakora kongera amahirwe y\'ubwandu kugira ngo bayirinde bityo ni ngombwa gusura muganga akagupima maze akaguha amabwiriza yuko uwufata buri munsi kandi kugira ngo agukingire mu buryo bwuzuye kuko kwegera inzobere mu buzima ari yo nzira yonyine yo kumenya niba uyu umuti ugukwiriye no kumenya uko uwukoresha neza ngo ubungunbe amagara yawe, kugira ngo ubeho mu mutekano usesuye kandi uzira amakemwa, icyorezo cya SIDA gikomeje kwibasira isi bityo PrEP ikaba ari intwaro ikomeye yo kwirinda gusa imiti nk\'iyi ntikunze kuboneka ahantu hose niyo pamvvu kubaza muganga wawe ari ngombwa ngo umenye amakuru ahagije.",
    category: 'SIDA',
    icon: 'pill',
  },
  {
  ...
  {
    fact: 'Buri mugore wese akwiye kwisuzumisha kanseri y\'inkondo y\'umura byibura rimwe mu myaka itatu kuko ari uburyo bwiza bwo kuvumbura hakiri kare ibimenyetso byose byatuma urwara bityo ni ngombwa kugana ivuriro rikwegereye kugira ngo uhabwe serivisi zo gusuzumwa no guhabwa amakuru ayizewe agufasha kubungabunga ubuzima bwawe no kwirinda ubu burwayi mu buryo buhoraho kandi bwizewe ,mu rwego rwo kurengera amagara yawe no kwitegura ejo heza hazaza hazira indwara zitamenyekana. iyi kanseri kandi barayikingira egera ikigo nderabuzima kikwegereye uhabwe amakuru yisumbuye niba utarakingirwa cg wifuza kumenya byinshi kuri iyi kanseri',
    category: 'Ubuzima',
    icon: 'heart',
  },
  {
    fact: 'Kugira ubusabane bwiza n’inshuti mufitanye icyizere ni inkingi ikomeye ifasha mu gusangira amakuru nyayo ku buzima bw’imyororokere bityo rero wirinde kwigirira icyizere gike kuko kuganirana ubwisanzure bituma ufata ibyemezo bikwiye bishingiye ku bumenyi uvomye ku bandi,kand bikakurinda guheranwa n’ipfunwe rishobora kukubuza kugera kuri serivisi z’ubuzima zikwiye kugira ngo ubashe kubungabunga amagara yawe n’umutekano w’igitsina cyawe mu buryo buhamye kandi buzira amakemwa, kuko ubumenyi ari mbaraga zo kwirinda. witinya kuganira n\'umubyeyi wawe cg inshuti zawe ku buzima bw\'imyororokere',
    category: 'Ubuzima',
    icon: 'users',
  },
];
...
export function getMensesPrediction(
  ...
  if (daysUntil > 2) {
    return {
      message: `Hasigaye iminsi ${daysUntil} ngo imihango yawe itangire.`,
      status: 'normal',
    };
  }
  ...
  if (daysUntil <= 2 && daysUntil > 0) {
    return {
      message:
        "Imihango yawe iri hafi gutangira (mu minsi 2). Ibuka kwitwaza ibikoresho by'isuku aho ugiye hose.",
      status: 'imminent',
    };
  }
